    ...
    >
      <div className="bg-white border-b border-gray-200 sticky top-0 z-40 px-4 py-3">
        <div className="flex items-center">
          <button
            onClick={() => navigate(-1)}
            className="p-2 -ml-2 mr-2 text-gray-500 hover:text-gray-900"
          >
          ...
          <div className="flex-1 relative">
            ...
            <input
              type="text"
              autoFocus
              className="block w-full pl-10 pr-10 py-2.5 border border-gray-200 rounded-full leading-5 bg-gray-50 placeholder-gray-500 focus:outline-none focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm transition-colors"
          ...
          loading ? (
            ...
            <div>
              ...
              <div className="space-y-3">
                {recentFacilities.map(facility => {
                  ...
                  const zone = ZONES.find(z => z.id === ward?.zoneId);
                  return (
                    <FacilityCard key={facility.id} facility={facility} ward={ward} zone={zone} />
                  );
                })}
              </div>
            </div>
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-500 text-sm">
                Search for facilities, medical officers, or locations.
              </p>
            </div>
          )
        ) : loading ? (
